...
const systems = [
  ...
  },
  {
    system_id: 'exchanges',
    system_name: 'حواله',
    actions: ['exchange_view', 'exchange_create', 'exchange_delete', 'exchange_restore','car_force_delete'],
    allowed_roles: ['admin', 'finance_manager', 'bank_manager'],
  },
  {
    system_id: 'orders',
    system_name: 'سفارشات',
    actions: ['order_view', 'order_create', 'order_delete', 'order_restore','car_force_delete'],
    allowed_roles: ['admin', 'finance_manager'],
  },
  {
    system_id: 'cars',

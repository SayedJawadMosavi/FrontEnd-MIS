            ...
            <VCardText>
              ...
              <div class="d-flex align-center">
                ...
                <VChip
                  ...
                  class="font-weight-medium"
                >
                  {{ orderInfo.payments_sum_amount ?? 0 }} $
                </VChip>
              </div>
    ...
    <VCol cols="12">
      ...
      >
        <VTable class="text-no-wrap">
          ...
          <tbody>
            <tr
              v-for="(item, index) in orderInfo.payments"
              :key="index"
...
const remaining = computed(() => {
  return props.orderInfo?.remainder
})
...
const editPayment = async (item, type = 'open') => {
  if (type == 'open') {
    ...
    try {
      ...
      const { data } = await axios.put(`order-payment`, editData.value)
